...
Unfortunately, with a latent space dimensionality of 2, both dimensions end up strongly correlated, which is not something we would want. That notwithstanding, let's see how we would explore transitions in that latent space.

```{r, eval = FALSE, fig.width = 8, fig.asp = 1}
torch <- import("torch")
n <- 8  
digit_size <- 28
